...
export const CardSpotlight = ({
  ...
  const content = (
    <div
      className={cn(
        "group/spotlight relative overflow-hidden rounded-xl border border-neutral-800 bg-black dark:border-neutral-800",
        className
      )}
      ...
      >
        {isHovering && (
          <CanvasRevealEffect
            ...
            opacities={[0.38, 0.38, 0.42, 0.55, 0.55, 0.65, 0.82, 0.86, 0.9, 1]}
            dotSize={3}
          />
        )}
      </motion.div>
