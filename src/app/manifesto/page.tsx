...
const manifestoSections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "We believe the last job is quant, as every serious field moves toward a feedback loop. Markets were the first obvious laboratory because the score was fast and brutal, but the same logic is spreading through everything that can be simulated, measured, forecasted, or optimized. Prediction markets sit at the center of that shift because they connect the generalist's ability to learn a system with the trader's need to be right under risk.",
      "Untitled Trading should be built for people who kept the dangerous part of themselves alive. The person we want reaches past coder, analyst, sports obsessive, political addict, or finance kid with a terminal. We want the mind that can enter an unfamiliar system, ignore the prestige map, and turn private judgment into disciplined work.",
      "That temperament is rare because it asks for traits that normally fight each other. Patience has to stay hard, aggression has to stay clean, humility has to remain active, and arrogance only stays useful when the record is allowed to kill it. Most people can hold one side of that tension for a while, then their psychology leaks into the trade. The company has to become a structure that keeps the tension productive.",
    ],
  },
  {
    label: "IV",
    ...
    paragraphs: [
      "Prediction markets have not yet reached their serious version. Liquidity is uneven, resolution standards are young, regulation will reshape the field, interfaces still feel early, and too much of the culture carries the smell of a casino. None of that makes the category less important. Early rails are supposed to look rough before the world understands what will run on them.",
      ...
      "There are ethical lines here, and pretending otherwise would be unserious. Some markets should never exist. Certain incentives remain ugly even when they create liquidity. A society that turns every human consequence into entertainment deserves the criticism it receives. The serious version uses markets as instruments for foresight, accountability, and risk discovery without letting spectacle become the point.",
      "That version can benefit institutions and outsiders at the same time. Companies become less able to lie to themselves. Public forecasts become measurable. Research communities gain a way to surface doubt earlier. Citizens get another sense organ for uncertainty. Outsiders with real knowledge can challenge stale authority without asking that authority for a seat at the table.",
    ],
  },
  {
    label: "V",
