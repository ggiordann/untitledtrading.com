  ...
  <>
    <footer className="flex flex-col px-8 lg:px-24 pb-5 lg:pb-10 items-start">
      <div className="flex flex-col gap-y-[0] w-full">
        <h1 className="tracking-tight font-aeonik-bold text-[24px] md:text-[108px] leading-[110%]">CONTACT US</h1>
        <h1 className="tracking-tight font-aeonik-bold text-[20px] md:text-[78px] text-end leading-none">CONTACT@UNTITLEDTRADING.COM</h1>
