...
const projects =[
  {
    ...
    year: "2024",
    description: "Using AI to build the fastest way to sell online. Led all design. Built React Native mobile app alongside founding team. Led SEO, growth, and GTM planning, leading to over 10,000 impressions and 1,500 users in two months.",
